...
const RetroAuthFormPreview = () => {
  ...
  return (
    <div className="retro-bg h-full flex items-center justify-center p-0 overflow-hidden relative">
      {/* Animated grid background */}
      <div className="grid-overlay absolute inset-0 z-0"></div>
      
      {/* Game-inspired container */}
      <div className="retro-container relative w-full rounded-lg border-4 border-[#FF00FF] shadow-[0_0_10px_rgba(0,255,255,0.5),0_0_20px_rgba(0,255,255,0.3),0_0_30px_rgba(0,255,255,0.1)] overflow-hidden z-10">
        {/* Header with game UI elements */}
        <div className="retro-header p-3 text-center relative">
          <div className="scanline absolute top-0 left-0 w-full h-full"></div>
          <h2 className="text-xl font-bold text-[#00FFFF] mb-1 tracking-wide" style={{textShadow: '0 0 5px rgba(0,255,255,0.7), 0 0 10px rgba(0,255,255,0.5)'}}>
          ...
          <div className="w-full bg-gray-800 h-4 rounded-full mb-2 relative overflow-hidden border-2 border-cyan-800">
            ...
            <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
              <div className="text-xs font-mono text-white z-10 font-bold tracking-wider" style={{textShadow: '0 0 2px #000'}}>
                XP: {xp}/100
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between px-2 text-[10px]">
            ...
            <div className="font-mono text-green-400" style={{animation: 'blink 1.5s infinite'}}>{isLoading ? 'PROCESSING...' : 'AWAITING INPUT'}</div>
          </div>
        </div>
        ...
        <div className="p-3 relative">
          ...
          <div className="grid grid-cols-3 gap-2 mb-3">
            <button 
              ...
              className="bg-blue-950 hover:bg-blue-900 text-white py-1 px-2 rounded-md border-b-4 border-blue-700 hover:border-blue-600 active:border-b-0 active:border-t-4 transition-all duration-150 relative"
            >
            ...
            <button 
              ...
              className="bg-gray-950 hover:bg-gray-900 text-white py-1 px-2 rounded-md border-b-4 border-gray-700 hover:border-gray-600 active:border-b-0 active:border-t-4 transition-all duration-150 relative"
            >
              <div className="flex justify-center items-center">
            ...
            <button 
              ...
              className="bg-purple-950 hover:bg-purple-900 text-white py-1 px-2 rounded-md border-b-4 border-purple-700 hover:border-purple-600 active:border-b-0 active:border-t-4 transition-all duration-150 relative"
            >
              <div className="flex justify-center items-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-2">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-blue-950 border-2 border-cyan-800 text-white px-2 py-1 text-sm rounded-md focus:outline-none focus:border-[#FF00FF] placeholder-cyan-700"
                    style={{textShadow: '0 0 5px rgba(0,255,255,0.3)'}}
                    placeholder="Enter username"
                    required={isSignUp}
                  />
                  <div className="absolute right-2 top-1.5 h-2 w-2">
                    {username && <div className="h-full w-full bg-green-500 rounded-full" style={{animation: 'pulse 1.5s infinite'}}></div>}
                  </div>
                </div>
              </div>
            )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                />
                <div className="absolute right-2 top-1.5 h-2 w-2">
                  {email && <div className="h-full w-full bg-green-500 rounded-full" style={{animation: 'pulse 1.5s infinite'}}></div>}
                </div>
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between mb-0.5">
                ...
                {!isSignUp && (
                  <a href="#" className="text-[10px] text-pink-400 hover:text-pink-300">FORGOT?</a>
                )}
              </div>
              <div className="relative">
                <input
                  ...
                  className="w-full bg-blue-950 border-2 border-cyan-800 text-white px-2 py-1 text-sm rounded-md focus:outline-none focus:border-[#FF00FF] placeholder-cyan-700 pr-8"
                  style={{textShadow: '0 0 5px rgba(0,255,255,0.3)'}}
                ...
                <button
                  ...
                  className="absolute right-2 top-1.5 text-cyan-500 hover:text-cyan-400 active:scale-90 transition-all duration-150"
                >
                  {passwordVisible ? (
                ...
                <div className="absolute right-8 top-1.5 h-2 w-2">
                  {password && <div className="h-full w-full bg-green-500 rounded-full" style={{animation: 'pulse 1.5s infinite'}}></div>}
                </div>
              </div>
              {password && (
                <div className="mt-1">
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-2 text-center text-white text-sm font-bold relative overflow-hidden transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed border-2"
                style={{borderImage: 'linear-gradient(to right, #00FFFF, #FF00FF) 1'}}
              >
