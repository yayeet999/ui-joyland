...
const AuthWithGoogleFormPreview = () => {
  ...
  return <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4 px-[16px] py-[2px] rounded-3xl">
      <div className="relative w-full max-w-md overflow-hidden bg-gray-800 p-6 md:p-8 shadow-2xl transition-all duration-300 hover:shadow-[0_0_80px_rgba(59,130,246,0.1)] px-[28px] my-[7px] rounded-3xl py-[4px]">
        ...
        <div className="relative z-10 backdrop-blur-sm px-[37px] py-px">
          ...
          <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4 px-0 py-0">
            {isSignUp && <div className="group relative">
                ...
                <div className="relative">
                  ...
                  <input type="text" value={name} onChange={e => setName(e.target.value)} className="block w-full rounded-lg border border-gray-600 bg-gray-700 p-2 pl-8 text-sm text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1" placeholder="John Doe" required={isSignUp} />
                </div>
            ...
            <div className="group relative">
              ...
              <div className="relative">
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} className="block w-full rounded-lg border border-gray-600 bg-gray-700 p-2 pl-8 text-sm text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1" placeholder="name@example.com" required />
              </div>
            ...
            <div className="group relative">
              ...
              <div className="relative">
                ...
                <input type={passwordVisible ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} className="block w-full rounded-lg border border-gray-600 bg-gray-700 p-2 pl-8 pr-8 text-sm text-white placeholder-gray-400 focus:border-blue-500 focus:outline-none focus:ring-1" placeholder="••••••••" required />
                <button type="button" onClick={() => setPasswordVisible(!passwordVisible)} className="absolute inset-y-0 right-0 flex items-center pr-2 text-gray-400 transition-all duration-300 hover:text-white active:scale-90">
                  {passwordVisible ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-4 w-4">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M3.98 8.223A10.477 10.477 0 001.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0112 4.5c4.756 0 8.773 3.162 10.065 7.498a10.523 10.523 0 01-4.293 5.774M6.228 6.228L3 3m3.228 3.228l3.65 3.65m7.894 7.894L21 21m-3.228-3.228l-3.65-3.65m0 0a3 3 0 10-4.243-4.243m4.242 4.242L9.88 9.88" />
                    </svg> : <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-4 w-4">
          ...
          <div className="mt-4 text-center text-xs md:text-sm text-gray-400">
            ...
            <button onClick={toggleMode} className="relative font-medium text-blue-400 transition-all duration-300 hover:text-blue-300 active:top-0.5">
