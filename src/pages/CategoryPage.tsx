        ...
        <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-[200px] flex items-center justify-center">
          {component.name === "Facebook Auth Button" ? (
            ...
            <div className="button-wrapper" style={{
              ...
              <button className="elegant-submit" style={{
                position: 'relative',
                width: '180px',
                height: '50px',
                padding: '0',
                ...
                <span className="button-content" style={{
                  ...
                  transition: 'all 0.4s cubic-bezier(0.16, 1, 0.3, 1)',
                  borderRadius: '7px',
                  boxShadow: '0 1px 2px rgba(0, 0, 0, 0.05), 0 1px 1px rgba(0, 0, 0, 0.03), inset 0 1px 0 rgba(255, 255, 255, 0.7)',
                  transform: 'translateZ(0)',
                ...
                <span className="button-border" style={{
                  position: 'absolute',
                  top: '0',
                  left: '0',
                  width: 'calc(100% + 4px)',
                ...
                <span className="button-shadow" style={{
                  position: 'absolute',
                  top: '0',
                  left: '0',
                  width: '100%',
